      ...
      <div className={styles.footer__container}>
        ...
        <div className={styles.footer__nav}>
          <ul className={styles.footer__navList}>
            ...
            <li className={styles.footer__navItem}>
              <Link href="/gallery" className={styles.footer__navLink}>Gallery</Link>
            </li>
            <li className={styles.footer__navItem}>
              <Link href="/about" className={styles.footer__navLink}>About Us</Link>
            </li>
            <li className={styles.footer__navItem}>
              <Link href="/contact" className={styles.footer__navLink}>Contact Us</Link>
            </li>
            <li className={styles.footer__navItem}>
              <Link href="/signup" className={styles.footer__navLink}>Sign Up</Link>
            </li>
          </ul>
        </div>

        {/* Column 3 - Explore Section */}
        <div className={styles.footer__explore}>
          ...
          <ul className={styles.footer__exploreList}>
            <li className={styles.footer__exploreItem}>
              <Link href="/niua" className={styles.footer__exploreLink}>NIUA</Link>
            </li>
            <li className={styles.footer__exploreItem}>
              <Link href="/mohua" className={styles.footer__exploreLink}>MoHUA</Link>
            </li>
            <li className={styles.footer__exploreItem}>
              <Link href="/digital-governance" className={styles.footer__exploreLink}>Centre for Digital Governance</Link>
            </li>
            <li className={styles.footer__exploreItem}>
              <Link href="/national-urban-digital-mission" className={styles.footer__exploreLink}>National Urban Digital Mission</Link>
            </li>
          </ul>
        </div>
        ...
        <div className={styles.footer__social}>
          ...
          <div className={styles.footer__socialLinks}>
            <Link href="#" className={styles.footer__socialLink} aria-label="Facebook">
            ...
            <Link href="#" className={styles.footer__socialLink} aria-label="Instagram">
              <div className={styles.footer__socialIcon}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Link href="#" className={styles.footer__socialLink} aria-label="X (Twitter)">
              <div className={styles.footer__socialIcon}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
