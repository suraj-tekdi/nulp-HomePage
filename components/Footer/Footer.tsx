      ...
      try {
        ...
        if (isMounted && res.success && Array.isArray(res.data)) {
          const filtered = (res.data as HomepageContactItem[])
            .filter(
              (item) =>
                item.category?.slug === "footer-contact-us" && item.is_active
            )
      ...
      <div className={styles.footer__container}>
        ...
        <div className={styles.footer__nav}>
          <ul className={styles.footer__navList}>
            ...
            <li className={styles.footer__navItem}>
              <Link href="/gallery" className={styles.footer__navLink}>
                Gallery
              </Link>
            </li>
            <li className={styles.footer__navItem}>
            ...
            <li className={styles.footer__navItem}>
              <Link href="/signup" className={styles.footer__navLink}>
                Sign Up
              </Link>
            </li>
          </ul>
        ...
        <div className={styles.footer__explore}>
          ...
          <ul className={styles.footer__exploreList}>
            <li className={styles.footer__exploreItem}>
              <Link href="/niua" className={styles.footer__exploreLink}>
                NIUA
              </Link>
            </li>
            <li className={styles.footer__exploreItem}>
              <Link href="/mohua" className={styles.footer__exploreLink}>
                MoHUA
              </Link>
            </li>
            <li className={styles.footer__exploreItem}>
            ...
            <li className={styles.footer__exploreItem}>
              <Link
                href="/national-urban-digital-mission"
                className={styles.footer__exploreLink}
              >
