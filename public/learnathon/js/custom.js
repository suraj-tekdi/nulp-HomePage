...
// Normalize Learnathon links to hide .html extension and use clean URLs
(function () {
  function normalizeLearnathonHref(href) {
    try {
      var u = new URL(href, window.location.origin + window.location.pathname);
      if (!u.pathname.startsWith("/learnathon/")) return null;
      // Remove trailing index.html and .html
      if (u.pathname.endsWith("/index.html")) {
        u.pathname = u.pathname.slice(0, -11) || "/learnathon/";
      }
      if (u.pathname.endsWith(".html")) {
        u.pathname = u.pathname.slice(0, -5);
      }
      // Ensure root index resolves to /learnathon
      if (u.pathname === "/learnathon/index") {
        u.pathname = "/learnathon/";
      }
